...
# Set datacenter-id to simulate the datacenter which redis node is in.               
proc setDatacenter_id {nodes datacenter_id} {
    foreach id $nodes {
        R $id config set datacenter-id $datacenter_id
        R $id config rewrite
